...
class WalletTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        if not self.options.descriptors:
            ...
            assert_raises_rpc_error(-5, "Invalid Snuff address", self.nodes[0].dumpprivkey, "invalid")

            # This will raise an exception for attempting to set a label for an invalid Bitcoin address
            assert_raises_rpc_error(-5, "Invalid Snuff address", self.nodes[0].setlabel, "invalid address", "label")

            # This will raise an exception for importing an invalid address
            assert_raises_rpc_error(-5, "Invalid Snuff address or script", self.nodes[0].importaddress, "invalid")
