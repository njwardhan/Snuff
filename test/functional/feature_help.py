...
"""Verify that starting snuff with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start snuff with -h for help text")
        ...
        self.log.info("Start snuff with -version for version information")
        ...
        self.log.info("Start snuffd with -fakearg to make sure it does not start")
