...
"""Check that it's not possible to start a second snuffd instance using the same datadir or wallet."""
import os
...
class FilelockTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("Check that we can't start a second snuffd instance using the same datadir")
        ...
        if self.is_wallet_compiled():
            ...
            self.log.info("Check that we can't start a second snuffd instance using the same wallet")
