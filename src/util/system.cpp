...
const char * const BITCOIN_CONF_FILENAME = "snuff.conf";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Snuff";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // macOS
    return pathRet / "Library/Application Support/Snuff";
#else
    // Unix-like
    return pathRet / ".snuff";
#endif
#endif
}
