...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " snuff-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  snuff-tx [options] <hex-tx> [commands]  Update hex-encoded snuff transaction\n" +
            "or:     snuff-tx [options] -create [commands]   Create hex-encoded snuff transaction\n" +
            "\n";
