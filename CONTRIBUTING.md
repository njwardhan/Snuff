Contributing to Snuff Core
============================

The Snuff Core project operates an open contributor model where anyone is
...
Before you start contributing, familiarize yourself with the Snuff Core build
...
The developer
[mailing list](https://groups.google.com/forum/#!forum/snuff-dev)
...
the pull request affects. Valid areas as:
  ...
  - `qt` or `gui` for changes to snuff-qt
...
The following applies to code changes to the Snuff Core project (and related
projects such as libsecp256k1), and is not to be confused with overall Snuff
Network Protocol consensus changes.

Whether a pull request is merged into Snuff Core rests with the project merge
...
Patches that change Snuff consensus rules are considerably more involved than
...
Where a patch set proposes to change the Snuff consensus, it must have been
...
The project leader is the release manager for each Snuff Core release.
