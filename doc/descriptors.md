# Support for Output Descriptors in Snuff Core

Since Snuff Core v0.17, there is support for Output Descriptors. This is a
...
existing Snuff Core wallets, a convenience function `combo` is
