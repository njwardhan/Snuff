Snuff Core version 0.21.2 is now available from:

 <https://download.snuff.org/snuff-0.21.2/>.
...
- This release implements the proposed MWEB consensus rules
  ([LIP002](https://github.com/snuff-project/lips/blob/master/lip-0002.mediawiki),
  [LIP003](https://github.com/snuff-project/lips/blob/master/lip-0003.mediawiki), and
  [LIP004](https://github.com/snuff-project/lips/blob/master/lip-0004.mediawiki))
